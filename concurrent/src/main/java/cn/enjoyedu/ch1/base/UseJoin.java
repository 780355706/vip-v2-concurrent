...
public class UseJoin {
    ...
    static class Goddess implements Runnable {
        ...
        public void run() {
            ...
            System.out.println(Thread.currentThread().getName() + "Goddess休息2秒...");
    ...
    static class GoddessBoyfriend implements Runnable {
        ...
        public void run() {
            System.out.println(Thread.currentThread().getName() + "GoddessBoyfriend休息2秒...");
            SleepTools.second(2);//休眠2秒
    ...
    public static void main(String[] args) throws Exception {
        ...
        g.join();
        System.out.println(Thread.currentThread().getName() + "休息2秒lison");
